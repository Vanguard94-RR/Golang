...
2. **Entradas y salidas ****esperadas (ejemplos).******
3. **Una pista sutil**

Restricciones:

- No generes documentacion no solicitada
- No generes salidas largas no solicitadas
- Utiliza solo paquetes y recursos default
